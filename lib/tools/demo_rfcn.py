...
import sys
sys.path.append("/home/huyangyang/rfcn/lib")
...
def demo(net, image_name):
    ...
    # Load the demo image
    im_file = os.path.join("/home/huyangyang/rfcn/data", 'demo', image_name)
...
if __name__ == '__main__':
    ...
    prototxt = os.path.join("/home/huyangyang/rfcn/models/pascal_voc", NETS[args.demo_net][0],
                            'rfcn_end2end', 'test_agonistic.prototxt')
    caffemodel = os.path.join("/home/huyangyang/rfcn/data", 'rfcn_models',
